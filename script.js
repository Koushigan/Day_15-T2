var optpage = document.createElement('page');
optpage.setAttribute('class', 'tableData')

var cur_page = 0;
var record_per_page = 10;
var max_pages = Math.ceil(100 / record_per_page);
...
p.setAttribute('class', 'anchorlist');
...
next.href = `javascript:nect_page()`;
next_id = "next";
...
document.body.append(heading, optpage, p);
p.append(prev, arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8], arr[9], next);
